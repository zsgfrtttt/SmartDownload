...
class SingleActivity : BaseSampleActivity() {
    ...
    private fun initTask() {
        ...
        val url = "https://oss-miaoyin.looyu.vip/android/4.0.2app-miaoyin-release.apk"
...
//            },
            ...
            if (cause == EndCause.COMPLETED) {
               /* val realMd5 = fileToMD5(task.file!!.absolutePath)
                ...
                val realMd5 = MD5Util.getFileMD5(task.file)
                Log.i("csz","md5   " + realMd5 +"    "+readableTotalLength);
            }
            realCause?.let {
